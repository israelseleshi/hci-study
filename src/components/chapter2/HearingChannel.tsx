    ...
    <section id="hearing" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-slate-900 to-indigo-950 text-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-white mb-4">Hearing</h2>
        ...
        <div className="max-w-5xl mx-auto mb-16">
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-orange-500/20">
            <h3 className="text-orange-400 mb-8 text-center">Characteristics of Sound</h3>
            
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-slate-800/50 rounded-xl p-6 border border-orange-400/20">
                <h4 className="text-orange-300 mb-4">Pitch</h4>
                <p className="text-gray-300 text-sm mb-4">The frequency of the sound wave (from low to high)</p>
              ...
              <div className="bg-slate-800/50 rounded-xl p-6 border border-orange-400/20">
                <h4 className="text-orange-300 mb-4">Loudness</h4>
                <p className="text-gray-300 text-sm mb-4">The amplitude or intensity of the sound wave</p>
                <svg viewBox="0 0 200 80" className="w-full h-auto">
              ...
              <div className="bg-slate-800/50 rounded-xl p-6 border border-orange-400/20">
                <h4 className="text-orange-300 mb-4">Timbre</h4>
                <p className="text-gray-300 text-sm mb-4">The unique quality that distinguishes different sounds</p>
                <svg viewBox="0 0 200 80" className="w-full h-auto">
        ...
        <div className="max-w-6xl mx-auto">
          <h3 className="text-center text-orange-400 mb-8">Uses of Sound in Interface Design</h3>
